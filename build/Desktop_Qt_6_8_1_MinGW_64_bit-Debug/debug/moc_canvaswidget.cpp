...
static constexpr auto qt_meta_stringdata_ZN12CanvasWidgetE = QtMocHelpers::stringData(
    "CanvasWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12CanvasWidgetE[] = {
...
Q_CONSTINIT const QMetaObject CanvasWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12CanvasWidgetE.offsetsAndSizes,
    qt_meta_data_ZN12CanvasWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12CanvasWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void *CanvasWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12CanvasWidgetE.stringdata0))
